...
thickness_fiberglass = 0.5;    % m (arbitrary)

A_thermal_mass_large_face = 5.1 * 5; % m^2
A_thermal_mass = A_thermal_mass_large_face * 2 + 5.1 * thickness_thermal_mass * 2 + 5 * thickness_thermal_mass * 2; % m^2
A_window = 2.6 * 5; % m^2, arbitrary window width of 5
A_wall = 5.1 * 5 + 6 * 5.1 + 3.2 * 2 * 5.1 + 3.2 * 5 + 0.4 * 5 + 0.2 * 5; % m^2

m_thermal_mass = thickness_thermal_mass * A_thermal_mass_large_face * p_thermal_mass;
% step 0
